...
//定义匹配需采集消息的正则
var REG_FORM_1_REQ = /INFO  cn.com.yitong.ares.net.esb.EsbSocketClient:[0-9]{2,3} - (.){1,90}交易esb加密前请求数据:/;
var REG_FORM_1_RSP = /INFO  cn.com.yitong.ares.net.esb.EsbSocketClient:[0-9]{2,3} - response data:/;
var REG_FORM_2_REQ = /INFO  cn.com.yitong.ares.net.bh.NetConnect4bhb:[0-9]{2,3} - 交易码：【[0-9]{2,3}\/[A-Z]{2,3}[0-9]{2,8}】百合服务--->金融平台:request:/;
var REG_FORM_2_RSP = /INFO  cn.com.yitong.ares.channel.JsonHttpMessageConverter:[0-9]{2,3} - 返回报文为：/;
var REG_FORM_3_REQ = /INFO  cn.com.yitong.ares.net.efel.NetConnect4efel:[0-9]{2,3} - inte request is:/;
var REG_FORM_3_RSP = /INFO  cn.com.yitong.ares.net.efel.NetConnect4efel:[0-9]{2,3} - inte response is:/;
var REG_FORM_4_REQ = /INFO  cn.com.yitong.ares.net.[a-z]{2,10}.SocketClient:[0-9]{2,3} - request data:/;
var REG_FORM_4_RSP = /INFO  cn.com.yitong.ares.net.[a-z]{2,10}.SocketClient:[0-9]{2,3} - response data:/;
