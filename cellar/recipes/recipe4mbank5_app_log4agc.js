...
const _msg_handler = (recipe, msg) => {
  ...
  // if msg from passive and active collector output, typeof msg is string;
  // if msg from agent collector, type msg is json object which contain "message" field

  const msg_dbg = (" " + msg).slice(1)
  ...
  try {
    ...
    logger.error({msg_dbg: msg_dbg}, "msg.trim() Exception:")
    return
  }
